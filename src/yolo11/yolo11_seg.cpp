...
// ROS2 YOLO11分割节点类
class YOLO11SegROSNode : public rclcpp::Node {
public:
    YOLO11SegROSNode() : Node("yolov8_seg_node") {
...
private:
    ...
    void initializeInference(std::string& engine_path) {
        ...
        image_sub_ = image_transport::create_subscription(
            this,
            image_topic,
            std::bind(&YOLO11SegROSNode::imageCallback, this, std::placeholders::_1),
            "raw",
...
int main(int argc, char** argv) {
    ...
    auto node = std::make_shared<YOLO11SegROSNode>();
    rclcpp::spin(node);
    rclcpp::shutdown();
